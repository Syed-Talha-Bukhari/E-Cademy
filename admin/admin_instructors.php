...
<body class="host_version">
    ...
    ?>
            <p>
                Wrong instructor code . Try deletion again
            </p>
    <?php
        }
    }
    ...
    ?>
            <p>
                Wrong instructor code . Try editing again
            </p>
    <?php
        }
    }
    ...
    <div class="section-title">
        <h2 style="color:#4c5a7d">Manage Instructors</h2>
    ...
    <div style="display: flex;">
        <div class="container">
            ...
            <div class="text-center pt-5">
                ...
                <button style="background-color: #4c5a7d" class="btn btn-primary w-sm waves-effect waves-light" onclick="window.location.href='admin_instructornew.php'">Create</button>
            </div>
            <div class="section-title mb-0 pb-2">

                <h5>Add new intructor</h5>
    ...
    <?php
    $query = "SELECT * FROM instructor NATURAL JOIN  instructor_details NATURAL JOIN instructor_info NATURAL JOIN instructor_login;";
    $result = mysqli_query($conn, $query);
    $check = mysqli_num_rows($result);

    if ($check > 0) { ?>
        <table>
            <caption>Instructor Records</caption>
        ...
        <div class="form-popup" id="myForm">
            <form method="POST" action="admin_instructordelete.php" class="form-container" ;>
                <div class="mb-3">
        ...
        <div class="form-popup" id="myForm1">
            <form method="POST" action="admin_instructoredit.php" class="form-container" ;>
                <div class="mb-3">
                    <label class="form-label" for="number"><b>Confirm Course Code</b></label>
                    <input type="text" name="number" id="number " class="form-control" placeholder="Course Code" required>
                </div>
