...
<body class="host_version">
    ...
    ?>
            <p>
                Wrong organization code . Try deletion again
            </p>
    <?php
        }
    }
    ...
    ?>
            <p>
                Wrong organization code . Try editing again
            </p>
    <?php
        }
    }
    ...
    <div class="section-title">
        <h2 style="color:#4c5a7d">Manage Organizations</h2>
    ...
    <div style="display: flex;">
        <div class="container">
            ...
            <div class="text-center pt-5">
                ...
                <button style="background-color: #4c5a7d" class="btn btn-primary w-sm waves-effect waves-light" onclick="window.location.href='admin_orgnew.php'">Create</button>
            </div>
    ...
    <?php
    $query = "SELECT * FROM organization NATURAL JOIN organizations_login;";
    $result = mysqli_query($conn, $query);
    $check = mysqli_num_rows($result);

    if ($check > 0) { ?>
        <table>
            <caption>Organization Records</caption>
        ...
        <div class="form-popup" id="myForm">
            <form method="POST" action="admin_orgdelete.php" class="form-container" ;>
                <div class="mb-3">
        ...
        <div class="form-popup" id="myForm1">
            <form method="POST" action="admin_orgedit.php" class="form-container" ;>
                <div class="mb-3">
                    <label class="form-label" for="number"><b>Confirm Course Code</b></label>
                    <input type="text" name="number" id="number " class="form-control" placeholder="Course Code" required>
                </div>
