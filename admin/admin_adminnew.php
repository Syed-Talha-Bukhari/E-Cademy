                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                ?>
                                <h5 class="text-primary"><b>Add admin</b></h5>

                            </div>
                            <div class="p-2 mt-4">
                                <form method="POST" action="admin_adminnewcheck.php">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="password" class="form-control" id="password" placeholder="Enter passowrd" required>
                                    </div>
                                    ...
                                    <div class="mt-3 text-end">
                                        <button name="login" class="btn btn-primary w-sm waves-effect waves-light" type="submit">Add admin</button>
                                    </div>
