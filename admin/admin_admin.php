...
<body class="host_version">
    ...
    <div class="section-title">
        <h2 style="color:#4c5a7d">Manage Admin</h2>

    </div>
    <?php
    $username = $_SESSION['username'];
    $query = "SELECT * FROM admin WHERE  access = '1' AND username = '$username';";
    ...
    if ($check > 0) { ?>
        <div style="display: flex;">
            <div class="container">
                ...
                <div class="text-center pt-5">
                    ...
                    <button style="background-color: #4c5a7d" class="btn btn-primary w-sm waves-effect waves-light" onclick="window.location.href='admin_adminnew.php'">Create</button>
                </div>
        ...
        <div class="form-popup" id="myForm">
            <form method="POST" action="admin_admindelete.php" class="form-container" ;>
                <div class="mb-3">
                    <label class="form-label" for="number"><b>Confirm Username</b></label>
                    <input type="text" name="number" id="number " class="form-control" placeholder="Username" required>
                </div>
        ...
        <div class="form-popup" id="myForm1">
            <form method="POST" action="admin_adminedit.php" class="form-container" ;>
                <div class="mb-3">
                    <label class="form-label" for="number"><b>Confirm Username</b></label>
                    <input type="text" name="number" id="number " class="form-control" placeholder="Username" required>
                </div>
    ...
    ?>
        <h6> echo 'Sorry you do not have access';
        </h6>
    <?php
    }
    ?>